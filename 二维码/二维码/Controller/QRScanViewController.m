...
- (void)viewDidLoad
{
    ...
    label.ly_centerX = self.view.ly_centerX;
    ...
    label.ly_height = textLabelHeight;
    label.ly_x = vLblHeight + kQRReaderScanHeight + kQRReaderScanLabelSpace;
    [self.view addSubview:label];
    
    self.headerLabel.frame = CGRectMake(0, 0, screenWidth, vLblHeight);
    self.footerLabel.frame = CGRectMake(0, vLblHeight + kQRReaderScanHeight, screenWidth, screenHeight - label.ly_x + kQRReaderScanLabelSpace);
...
- (UIView *)blackCoverView
{
    if (!_blackCoverView) {
        ...
        UILabel *loadLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.activityView.ly_frameMaxX + 10, kScreenWidth, 30)];
...
- (UIActivityIndicatorView *)activityView
{
    if (!_activityView)
    {
        ...
        _activityView.center = CGPointMake(CGRectGetMidX(_cropRect), CGRectGetMidY(_cropRect));
